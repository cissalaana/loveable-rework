...
export const PROJECTS: Project[] = [
  {
    ...
    gallery: ["/assets/MockupGuardiã.png", "/assets/MockupGuardiã2.png", "/assets/MockupGuardiã3.png", "/assets/MockupGuardiã4.png", "/assets/MockupGuardiã5.png", "/assets/MockupGuardiã6.png"],
