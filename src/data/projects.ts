...
export const PROJECTS: Project[] = [
  {
    ...
    sprints: [
      ...
      },
      {
        ...
        sections: [
          { type: "text", title: "Desk Research & Benchmarking", text: "Iniciamos com uma desk research para mapear dados existentes sobre violência de gênero em campi universitários no Brasil e no mundo. Paralelamente, realizamos benchmarking com soluções semelhantes — como apps de segurança pessoal e dispositivos vestíveis — para identificar referências e oportunidades de diferenciação." },
          { type: "text", title: "Pesquisa Quantitativa", text: "Aplicamos um questionário online com 74 respostas de estudantes de diferentes cursos da UFPE, investigando perfil demográfico, frequência no campus, meios de locomoção, percepção de segurança e satisfação com as medidas existentes. Os dados revelaram que o problema não está apenas nos edifícios, mas nos deslocamentos entre eles." },
